...
| 厂商 | 目录 | 翻译状态 |
|------|------|----------|
| Anthropic (Claude) | [ANTHROPIC](./ANTHROPIC) | 待翻译 |
| OpenAI (ChatGPT) | [OPENAI](./OPENAI) | 待翻译 |
| Google (Gemini) | [GOOGLE](./GOOGLE) | 待翻译 |
...
| Replit | [REPLIT](./REPLIT) | 待翻译 |
| Meta | [META](./META) | 待翻译 |
| Mistral | [MISTRAL](./MISTRAL) | 待翻译 |
| Moonshot (Kimi) | [MOONSHOT](./MOONSHOT) | 待翻译 |
| MiniMax | [MINIMAX](./MINIMAX) | 待翻译 |
