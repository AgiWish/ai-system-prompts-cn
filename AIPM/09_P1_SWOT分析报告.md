...
- 文档专属表达：围绕《SWOT分析报告》的评审场景写作，优先呈现该文档最需要支撑的决策，而不是复述通用产品方法论。
...
0. 【启动判断】收到用户输入后，先评估信息完整度：
   ...
   - 禁止在信息足够时反复追问，禁止在信息严重不足时编造《SWOT分析报告》的关键事实、指标或结论。
...
| 2. 分析对象与结论摘要 | 围绕“分析对象与结论摘要”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 3. 内部优势 Strengths | 围绕“内部优势 Strengths”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 4. 内部劣势 Weaknesses | 围绕“内部劣势 Weaknesses”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 5. 外部机会 Opportunities | 围绕“外部机会 Opportunities”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 6. 外部威胁 Threats | 围绕“外部威胁 Threats”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 7. SWOT 矩阵 | 围绕“SWOT 矩阵”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 8. TOWS 策略组合 | 围绕“TOWS 策略组合”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 9. 策略优先级与行动计划 | 围绕“策略优先级与行动计划”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 10. 风险与待验证假设 | 围绕“风险与待验证假设”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
...
|---|---|---|---|---|---|
| 《SWOT分析报告》核心章节完整 | 是/否 | 章节编号 | 高/中/低 | 补齐缺失内容 | 文档 DRI |
...
- 禁止在《SWOT分析报告》中只给抽象原则，不给具体表格字段、图示要求、验收口径和责任角色。
