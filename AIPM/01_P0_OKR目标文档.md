...
| 序号 | 关键判断 | 要求 |
|---|---|---|
| 1 | Objective 是否聚焦且可被管理层理解 | 需给出结论、依据、Owner、下一步 |
| 2 | KR 是否可量化且有数据源 | 需给出结论、依据、Owner、下一步 |
| 3 | 指标是否同时覆盖业务、用户、模型和风险 | 需给出结论、依据、Owner、下一步 |
| 4 | 团队 Owner 是否唯一明确 | 需给出结论、依据、Owner、下一步 |
| 5 | 复盘节奏是否能发现偏差并触发动作 | 需给出结论、依据、Owner、下一步 |
...
| 2. 背景与战略对齐 | 业务背景、战略目标、当前阶段、关键约束 | 说明为什么现在要做 |
| 3. 总目标与北极星指标 | Objective、北极星指标、基线、目标值、周期 | 指标可量化且可追踪 |
| 4. OKR 总览表 | Objective、KR、基线、目标、Owner、数据源 | 每个KR有明确验收口径 |
| 5. 关键结果口径定义 | 围绕“关键结果口径定义”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 6. 指标拆解树 | 围绕“指标拆解树”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 7. 团队承接与 RACI | 围绕“团队承接与 RACI”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 8. 里程碑与检查节奏 | 围绕“里程碑与检查节奏”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 9. 风险与护栏指标 | 围绕“风险与护栏指标”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
| 10. 复盘机制与下阶段输入 | 围绕“复盘机制与下阶段输入”输出结论、依据、表格、图示、风险和下一步 | 内容完整、可评审、可执行 |
