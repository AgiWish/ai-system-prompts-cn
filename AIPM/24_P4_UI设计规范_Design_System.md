...
|---|---|---|---|---|---|
| 1 | Token 是否可实现 | 待填写 | 待填写 | 具体角色 | 具体动作 |
| 2 | 组件状态是否完整 | 待填写 | 待填写 | 具体角色 | 具体动作 |
| 3 | AI 组件是否覆盖信任和控制 | 待填写 | 待填写 | 具体角色 | 具体动作 |
| 4 | 是否有 A11y 规则 | 待填写 | 待填写 | 具体角色 | 具体动作 |
| 5 | 是否有治理机制 | 待填写 | 待填写 | 具体角色 | 具体动作 |

### 章节填写要求
| 章节 | 必填内容 | 验收标准 |
|---|---|---|
| 1. 文档元信息 | 文档名称、所属阶段、产品/项目、版本、DRI、评审对象、更新时间、状态 | 字段完整，无空白关键责任人 |
| 2. 设计原则与品牌方向 | 品牌色（主色/辅色/中性色）、字体家族与字重、Logo使用规范 | 内容完整、可评审、可执行 |
| 3. Design Tokens | 语义色（成功/警告/错误/信息）、深色模式适配、色彩对比度WCAG等级 | 内容完整、可评审、可执行 |
| 4. 布局与响应式规则 | 字号阶梯（H1-H6+Body+Caption）、行高、字间距、中英文混排规则 | 内容完整、可评审、可执行 |
| 5. 基础组件规范 | 基础单位（4px/8px）、栅格列数、间距等级（4/8/12/16/24/32）、容器最大宽度 | 内容完整、可评审、可执行 |
| 6. 业务组件规范 | 组件名称、变体列表、状态（正常/hover/active/disabled/错误）、Props说明 | 内容完整、可评审、可执行 |
| 7. AI 组件规范 | 图标库来源、尺寸规格、使用规则、插图风格指南 | 内容完整、可评审、可执行 |
